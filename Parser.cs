...
// DateTime: 07.09.2024 18:22:14
// UserName: Paulsams
// Input file <ParserGenerator\SpecFiles\gppg.y - 07.09.2024 18:22:13>
...
{
internal enum Token {
    error=127,EOF=128,fieldOffset=129,codeStart=130,codeEnd=131,ident=132,
    anchoredSymbol=133,number=134,filePath=135,litstring=136,verbatim=137,litchar=138,
    kwPCPC=139,kwLbrace=140,kwRbrace=141,kwToken=142,kwType=143,kwLeft=144,
    kwRight=145,kwNonassoc=146,kwPrec=147,kwStart=148,kwUnion=149,kwDefines=150,
    kwLocations=151,kwNamespace=152,kwPartial=153,kwOutput=154,kwShareTokens=155,kwImportTokens=156,
    kwParsertype=157,kwTokentype=158,kwScanbasetype=159,kwUsing=160,kwVisibility=161,kwYYSTYPE=162,
    kwYYLTYPE=163,kwCsTokenFile=164,maxParseToken=165,errTok=166};
...
{
  // Verbatim content from ParserGenerator\SpecFiles\gppg.y - 07.09.2024 18:22:13
/*
 *  Parser spec for GPPG
 *  gppg.y: Author: John Gough, August 2008
 *  Process with > GPPG /gplex /no-lines gppg.y
 */
  // End verbatim content from ParserGenerator\SpecFiles\gppg.y - 07.09.2024 18:22:13
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{140,46,142,50,143,79,144,88,145,91,146,94,148,97,149,99,151,132,150,133,164,134,153,135,155,136,156,137,152,142,160,144,154,148,159,153,157,155,161,157,158,159,162,161,163,163,127,166,139,-11},new int[]{-10,1,-12,3,-17,44,-18,165,-19,49});
    states[1] = new State(new int[]{128,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{139,43},new int[]{-13,4});
    states[4] = new State(new int[]{133,39,127,42},new int[]{-14,5,-34,41,-35,13});
    states[5] = new State(new int[]{139,8,133,39,128,-6},new int[]{-15,6,-34,7,-35,13});
    states[6] = new State(-2);
    states[7] = new State(-91);
    states[8] = new State(new int[]{130,10,128,-8},new int[]{-16,9});
    states[9] = new State(-5);
    states[10] = new State(new int[]{131,11,127,12});
    states[11] = new State(-7);
    states[12] = new State(-9);
    states[13] = new State(new int[]{132,24,138,25,136,26,123,29,147,33,59,-98,124,-98},new int[]{-6,14,-7,19,-4,36,-37,27,-9,37,-8,28});
    states[14] = new State(-96,new int[]{-36,15});
    states[15] = new State(new int[]{59,16,124,17});
    states[16] = new State(-94);
    states[17] = new State(new int[]{132,24,138,25,136,26,123,29,147,33,59,-98,124,-98},new int[]{-6,18,-7,19,-4,36,-37,27,-9,37,-8,28});
    states[18] = new State(-97);
    states[19] = new State(new int[]{123,29,147,33,59,-99,124,-99},new int[]{-9,20,-8,28});
    states[20] = new State(new int[]{132,24,138,25,136,26,123,-103,147,-103,59,-103,124,-103},new int[]{-5,21,-4,22,-37,27});
    states[21] = new State(-102);
    states[22] = new State(new int[]{132,24,138,25,136,26,123,-104,147,-104,59,-104,124,-104},new int[]{-37,23});
    ...
    states[29] = new State(new int[]{130,10,125,-8,127,-8},new int[]{-16,30});
    states[30] = new State(new int[]{125,31,127,32});
    states[31] = new State(-113);
    states[32] = new State(-114);
    states[33] = new State(new int[]{132,34});
    states[34] = new State(new int[]{123,29,132,-112,138,-112,136,-112,147,-112,59,-112,124,-112},new int[]{-8,35});
    states[35] = new State(-111);
    states[36] = new State(new int[]{132,24,138,25,136,26,123,-100,147,-100,59,-100,124,-100},new int[]{-37,23});
    states[37] = new State(new int[]{132,24,138,25,136,26,123,-103,147,-103,59,-103,124,-103},new int[]{-5,38,-4,22,-37,27});
    ...
    states[44] = new State(new int[]{140,46,142,50,143,79,144,88,145,91,146,94,148,97,149,99,151,132,150,133,164,134,153,135,155,136,156,137,152,142,160,144,154,148,159,153,157,155,161,157,158,159,162,161,163,163,139,-10},new int[]{-18,45,-19,49});
    states[45] = new State(-13);
    states[46] = new State(new int[]{130,10,141,-8},new int[]{-16,47});
    states[47] = new State(new int[]{141,48});
    states[48] = new State(-16);
    states[49] = new State(-17);
    states[50] = new State(new int[]{60,74,132,-49,138,-49},new int[]{-20,51,-21,73});
    states[51] = new State(new int[]{132,55,138,59},new int[]{-1,52,-2,72});
    states[52] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,140,-18,142,-18,143,-18,144,-18,145,-18,146,-18,148,-18,149,-18,151,-18,150,-18,164,-18,153,-18,155,-18,156,-18,152,-18,160,-18,154,-18,159,-18,157,-18,161,-18,158,-18,162,-18,163,-18,139,-18,132,-78,138,-78},new int[]{-28,53,-29,60});
    states[53] = new State(new int[]{132,55,138,59},new int[]{-2,54});
    states[54] = new State(-53);
    states[55] = new State(new int[]{134,56,136,57,44,-57,59,-57,58,-57,60,-57,62,-57,40,-57,41,-57,91,-57,93,-57,123,-57,125,-57,132,-57,138,-57,140,-57,142,-57,143,-57,144,-57,145,-57,146,-57,148,-57,149,-57,151,-57,150,-57,164,-57,153,-57,155,-57,156,-57,152,-57,160,-57,154,-57,159,-57,157,-57,161,-57,158,-57,162,-57,163,-57,139,-57});
    states[56] = new State(-55);
    states[57] = new State(new int[]{134,58,44,-58,59,-58,58,-58,60,-58,62,-58,40,-58,41,-58,91,-58,93,-58,123,-58,125,-58,132,-58,138,-58,140,-58,142,-58,143,-58,144,-58,145,-58,146,-58,148,-58,149,-58,151,-58,150,-58,164,-58,153,-58,155,-58,156,-58,152,-58,160,-58,154,-58,159,-58,157,-58,161,-58,158,-58,162,-58,163,-58,139,-58});
    ...
    states[74] = new State(new int[]{132,75,127,77});
    ...
    states[80] = new State(new int[]{132,84,133,85},new int[]{-3,81,-22,87});
    states[81] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,140,-19,142,-19,143,-19,144,-19,145,-19,146,-19,148,-19,149,-19,151,-19,150,-19,164,-19,153,-19,155,-19,156,-19,152,-19,160,-19,154,-19,159,-19,157,-19,161,-19,158,-19,162,-19,163,-19,139,-19,132,-78,133,-78},new int[]{-28,82,-29,86});
    states[82] = new State(new int[]{132,84,133,85},new int[]{-22,83});
    states[83] = new State(-61);
    states[84] = new State(-63);
    states[85] = new State(-64);
    states[86] = new State(-62);
    states[87] = new State(-60);
    states[88] = new State(new int[]{60,74,132,-49,138,-49},new int[]{-20,89,-21,73});
    states[89] = new State(new int[]{132,55,138,59},new int[]{-1,90,-2,72});
    states[90] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,140,-20,142,-20,143,-20,144,-20,145,-20,146,-20,148,-20,149,-20,151,-20,150,-20,164,-20,153,-20,155,-20,156,-20,152,-20,160,-20,154,-20,159,-20,157,-20,161,-20,158,-20,162,-20,163,-20,139,-20,132,-78,138,-78},new int[]{-28,53,-29,60});
    states[91] = new State(new int[]{60,74,132,-49,138,-49},new int[]{-20,92,-21,73});
    states[92] = new State(new int[]{132,55,138,59},new int[]{-1,93,-2,72});
    states[93] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,140,-21,142,-21,143,-21,144,-21,145,-21,146,-21,148,-21,149,-21,151,-21,150,-21,164,-21,153,-21,155,-21,156,-21,152,-21,160,-21,154,-21,159,-21,157,-21,161,-21,158,-21,162,-21,163,-21,139,-21,132,-78,138,-78},new int[]{-28,53,-29,60});
    states[94] = new State(new int[]{60,74,132,-49,138,-49},new int[]{-20,95,-21,73});
    states[95] = new State(new int[]{132,55,138,59},new int[]{-1,96,-2,72});
    states[96] = new State(new int[]{44,61,59,62,58,63,60,64,62,65,40,66,41,67,91,68,93,69,123,70,125,71,140,-22,142,-22,143,-22,144,-22,145,-22,146,-22,148,-22,149,-22,151,-22,150,-22,164,-22,153,-22,155,-22,156,-22,152,-22,160,-22,154,-22,159,-22,157,-22,161,-22,158,-22,162,-22,163,-22,139,-22,132,-78,138,-78},new int[]{-28,53,-29,60});
    states[97] = new State(new int[]{132,84,133,85},new int[]{-22,98});
    states[98] = new State(-23);
    states[99] = new State(new int[]{132,131,123,-45},new int[]{-23,100});
    states[100] = new State(new int[]{123,102},new int[]{-24,101});
    states[101] = new State(-24);
    states[102] = new State(new int[]{91,106,127,130},new int[]{-31,103,-32,129});
    states[103] = new State(new int[]{125,104,91,106},new int[]{-32,105});
    states[104] = new State(-70);
    states[105] = new State(-72);
    states[106] = new State(new int[]{129,107});
    states[107] = new State(new int[]{40,108});
    states[108] = new State(new int[]{134,109});
    states[109] = new State(new int[]{41,110});
    states[110] = new State(new int[]{93,111});
    states[111] = new State(new int[]{132,126},new int[]{-33,112,-27,128,-25,116});
    states[112] = new State(new int[]{132,113},new int[]{-27,115,-25,116});
    states[113] = new State(new int[]{59,114,91,-47,46,-47,60,-47,132,-47});
    states[114] = new State(-74);
    states[115] = new State(-76);
    states[116] = new State(new int[]{91,117,46,119,60,121,132,-67,62,-67,44,-67,140,-67,142,-67,143,-67,144,-67,145,-67,146,-67,148,-67,149,-67,151,-67,150,-67,164,-67,153,-67,155,-67,156,-67,152,-67,160,-67,154,-67,159,-67,157,-67,161,-67,158,-67,162,-67,163,-67,139,-67});
    states[117] = new State(new int[]{93,118});
    states[118] = new State(-65);
    states[119] = new State(new int[]{132,120});
    states[120] = new State(-46);
    states[121] = new State(new int[]{132,126},new int[]{-30,122,-27,127,-25,116});
    states[122] = new State(new int[]{62,123,44,124});
    states[123] = new State(-66);
    states[124] = new State(new int[]{132,126},new int[]{-27,125,-25,116});
    states[125] = new State(-69);
    states[126] = new State(-47);
    states[127] = new State(-68);
    ...
    states[137] = new State(new int[]{61,138});
    states[138] = new State(new int[]{135,139,136,140,137,141});
    states[139] = new State(-30);
    states[140] = new State(-31);
    states[141] = new State(-32);
    states[142] = new State(new int[]{132,126},new int[]{-25,143});
    states[143] = new State(new int[]{46,119,140,-33,142,-33,143,-33,144,-33,145,-33,146,-33,148,-33,149,-33,151,-33,150,-33,164,-33,153,-33,155,-33,156,-33,152,-33,160,-33,154,-33,159,-33,157,-33,161,-33,158,-33,162,-33,163,-33,139,-33});
    states[144] = new State(new int[]{132,126},new int[]{-25,145});
    states[145] = new State(new int[]{46,119,59,147,140,-80,142,-80,143,-80,144,-80,145,-80,146,-80,148,-80,149,-80,151,-80,150,-80,164,-80,153,-80,155,-80,156,-80,152,-80,160,-80,154,-80,159,-80,157,-80,161,-80,158,-80,162,-80,163,-80,139,-80},new int[]{-26,146});
    states[146] = new State(-34);
    states[147] = new State(-79);
    states[148] = new State(new int[]{61,149});
    states[149] = new State(new int[]{135,150,136,151,137,152});
    states[150] = new State(-35);
    states[151] = new State(-36);
    states[152] = new State(-37);
    states[153] = new State(new int[]{132,154});
    states[154] = new State(-38);
    states[155] = new State(new int[]{132,156});
    states[156] = new State(-39);
    states[157] = new State(new int[]{132,158});
    states[158] = new State(-40);
    states[159] = new State(new int[]{132,160});
    states[160] = new State(-41);
    states[161] = new State(new int[]{132,126},new int[]{-27,162,-25,116});
    states[162] = new State(-42);
    states[163] = new State(new int[]{132,126},new int[]{-27,164,-25,116});
    states[164] = new State(-43);
    states[165] = new State(-14);
    states[166] = new State(new int[]{140,46,142,50,143,79,144,88,145,91,146,94,148,97,149,99,151,132,150,133,164,134,153,135,155,136,156,137,152,142,160,144,154,148,159,153,157,155,161,157,158,159,162,161,163,163,139,-12,128,-3},new int[]{-18,167,-19,49});
    ...
    rules[4] = new Rule(-13, new int[]{139});
    rules[5] = new Rule(-15, new int[]{139,-16});
    rules[6] = new Rule(-15, new int[]{});
    rules[7] = new Rule(-16, new int[]{130,131});
    rules[8] = new Rule(-16, new int[]{});
    rules[9] = new Rule(-16, new int[]{130,127});
    ...
    rules[16] = new Rule(-18, new int[]{140,-16,141});
    rules[17] = new Rule(-18, new int[]{-19});
    rules[18] = new Rule(-19, new int[]{142,-20,-1});
    rules[19] = new Rule(-19, new int[]{143,-21,-3});
    rules[20] = new Rule(-19, new int[]{144,-20,-1});
    rules[21] = new Rule(-19, new int[]{145,-20,-1});
    rules[22] = new Rule(-19, new int[]{146,-20,-1});
    rules[23] = new Rule(-19, new int[]{148,-22});
    rules[24] = new Rule(-19, new int[]{149,-23,-24});
    rules[25] = new Rule(-19, new int[]{151});
    rules[26] = new Rule(-19, new int[]{150});
    rules[27] = new Rule(-19, new int[]{164});
    rules[28] = new Rule(-19, new int[]{153});
    rules[29] = new Rule(-19, new int[]{155});
    rules[30] = new Rule(-19, new int[]{156,61,135});
    rules[31] = new Rule(-19, new int[]{156,61,136});
    rules[32] = new Rule(-19, new int[]{156,61,137});
    rules[33] = new Rule(-19, new int[]{152,-25});
    rules[34] = new Rule(-19, new int[]{160,-25,-26});
    rules[35] = new Rule(-19, new int[]{154,61,135});
    rules[36] = new Rule(-19, new int[]{154,61,136});
    rules[37] = new Rule(-19, new int[]{154,61,137});
    rules[38] = new Rule(-19, new int[]{159,132});
    rules[39] = new Rule(-19, new int[]{157,132});
    rules[40] = new Rule(-19, new int[]{161,132});
    rules[41] = new Rule(-19, new int[]{158,132});
    rules[42] = new Rule(-19, new int[]{162,-27});
    rules[43] = new Rule(-19, new int[]{163,-27});
    rules[44] = new Rule(-23, new int[]{132});
    rules[45] = new Rule(-23, new int[]{});
    rules[46] = new Rule(-25, new int[]{-25,46,132});
    rules[47] = new Rule(-25, new int[]{132});
    rules[48] = new Rule(-20, new int[]{-21});
    rules[49] = new Rule(-20, new int[]{});
    rules[50] = new Rule(-21, new int[]{60,132,62});
    ...
    rules[55] = new Rule(-2, new int[]{132,134});
    rules[56] = new Rule(-2, new int[]{132,136,134});
    rules[57] = new Rule(-2, new int[]{132});
    rules[58] = new Rule(-2, new int[]{132,136});
    rules[59] = new Rule(-2, new int[]{138});
    ...
    rules[64] = new Rule(-22, new int[]{133});
    ...
    rules[74] = new Rule(-32, new int[]{91,129,40,134,41,93,-33,132,59});
    ...
    rules[95] = new Rule(-35, new int[]{133,58});
    ...
    rules[107] = new Rule(-37, new int[]{132});
    rules[108] = new Rule(-37, new int[]{138});
    rules[109] = new Rule(-37, new int[]{136});
    rules[110] = new Rule(-9, new int[]{-8});
    rules[111] = new Rule(-9, new int[]{147,132,-8});
    rules[112] = new Rule(-9, new int[]{147,132});
    rules[113] = new Rule(-8, new int[]{123,-16,125});
    rules[114] = new Rule(-8, new int[]{123,-16,127});

    aliases = new Dictionary<int, string>();
    aliases.Add(129, "FieldOffset");
    aliases.Add(139, "%%");
    aliases.Add(140, "%{");
    aliases.Add(141, "%}");
    aliases.Add(142, "%token");
    aliases.Add(143, "%type");
    aliases.Add(144, "%left");
    aliases.Add(145, "%right");
    aliases.Add(146, "%nonassoc");
    aliases.Add(147, "%prec");
    aliases.Add(148, "%start");
    aliases.Add(149, "%union");
    aliases.Add(150, "%defines");
    aliases.Add(151, "%locations");
    aliases.Add(152, "%namespace");
    aliases.Add(153, "%partial");
    aliases.Add(154, "%output");
    aliases.Add(155, "%sharetokens");
    aliases.Add(156, "%importtokens");
    aliases.Add(157, "%parsertype");
    aliases.Add(158, "%tokentype");
    aliases.Add(159, "%scanbasetype");
    aliases.Add(160, "%using");
    aliases.Add(161, "%visibility");
    aliases.Add(162, "%YYSTYPE");
    aliases.Add(163, "%YYLTYPE");
    aliases.Add(164, "%cstokenfile");
  }
